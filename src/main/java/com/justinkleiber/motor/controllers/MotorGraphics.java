 ...
 *
 */
public class MotorGraphics implements Graphics{
     ...
     */
	public MotorGraphics(AssetManager assets, Bitmap frame)
	{
		this.assets=assets;
		this.frame=frame;
	...
	public Sprite newSprite(String file) {
		...
		return new MotorSprite(b,format);
	}
	...
	public Backdrop newBackdrop(String file) {
		...
		format = ImageFormat.RGB565;
		return new MotorBackdrop(b, format);
	}

	@Override
	public void drawSprite(Sprite s, int x, int y) {
		// TODO Auto-generated method stub
		canvas.drawBitmap(((MotorSprite) s).bitmap, x, y, null);
	}
	...
	public void drawBackdrop(Backdrop b) {
		...
		canvas.drawBitmap(((MotorBackdrop) b).bitmap, src, dst, null);
	}
	...
	public SpriteSheet newSpriteSheet(String file, int rows, int cols) {
		...
		format = ImageFormat.RGB565;
		return new MotorSpriteSheet(b,rows,cols,format);
	}
	...
	public void drawSprite(Sprite s, Position p) {
		// TODO Auto-generated method stub
		canvas.drawBitmap(((MotorSprite) s).bitmap, p.x, p.y, null);
	...
	public void drawSprite(Sprite s) {
		// TODO Auto-generated method stub
		canvas.drawBitmap(((MotorSprite) s).bitmap, s.getPosition().x, s.getPosition().y, null);
	}
