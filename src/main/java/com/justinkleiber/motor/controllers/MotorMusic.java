 ...
 *
 */
public class MotorMusic implements Music, OnCompletionListener, OnSeekCompleteListener, OnPreparedListener, OnVideoSizeChangedListener {
	 ...
	 */
	public MotorMusic(AssetFileDescriptor assetDescriptor) {
