 ...
 *
 */
public class MotorSpriteSheet implements SpriteSheet {
	 ...
	 * @param b The Bitmap that the SpriteSheet represents
	 ...
	 */
	MotorSpriteSheet(Bitmap b, int rows, int cols, ImageFormat format)
	{
		this.bitmap=b;
		this.rows = rows;
		this.cols = cols;
